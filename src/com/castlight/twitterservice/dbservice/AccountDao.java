...
public class AccountDao {
	...
	public Users getUserDetails(int userId)
	{
	      ...
	      List<Integer> followerList = entitymanager.createNamedQuery("Follower.findFollowers").setParameter("user_id", userId).getResultList();
	      ...
	      List<Integer> followingList = entitymanager.createNamedQuery("Follower.findFollowing").setParameter("user_id", userId).getResultList();
	      ...
	      List<Tweet> tweetList = entitymanager.createNamedQuery("Tweet.findAll").setParameter("user_id", userId).getResultList();
